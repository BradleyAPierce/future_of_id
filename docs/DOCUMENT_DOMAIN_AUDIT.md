...
| `FUTURE_READY_CAPABILITY_MODEL.md` | `docs/strategy/` | Strategy | Source of Truth | High | Keep | Authoritative seven-capability model and rationale. | Root README should list, not duplicate, its rationale. |
