...
| `FUTURE_READY_CAPABILITY_MODEL.md` | `docs/strategy/` | Strategy | Keep | Defines the seven-capability model, audience, transformation, research basis, and capability rationale. | Authoritative for capability model. Do not dilute or duplicate elsewhere. |
