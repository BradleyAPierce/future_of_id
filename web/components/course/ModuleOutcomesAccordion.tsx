...
export default function ModuleOutcomesAccordion({
  ...
  return (
    <details className="group rounded-[var(--radius-xl)] border border-[var(--border)] bg-[var(--surface)] p-2 shadow-[var(--shadow-sm)] open:border-[var(--primary)] open:bg-[var(--surface-elevated)]">
      <summary className="flex cursor-pointer list-none items-center gap-4 rounded-[var(--radius-md)] p-4 transition hover:bg-[var(--surface-elevated)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]">
