...
const moduleSpecificReviewCriteriaBySlug: Record<string, string> = {
  ...
  "adaptive-learning":
    "For Adaptive and Personalized Learning responses, evaluate whether the learner identified a meaningful learner difference, whether evidence actually justifies adaptation, whether the trigger is appropriate, whether the proposed learning response matches the learner need, whether unnecessary personalization or complexity was avoided, whether the adaptation supports learner or business outcomes, and whether the learner demonstrated sound professional judgment. Do not reward personalization without evidence, technology for its own sake, adaptive pathways that add maintenance cost without learner benefit, or complexity without instructional value. Reinforce that complexity should be earned.",
  "content-systems":
    "For Content Systems Thinking and Workflow Automation responses, evaluate whether the learner identified reusable content opportunities, defined structured learning objects appropriately, created reuse rules that protect instructional context, included governance that supports long-term quality, made workflow decisions that reduce maintenance without reducing learning quality, used automation intentionally rather than simply replacing manual work, and demonstrated sound systems thinking and professional judgment. Do not reward reusing content without protecting instructional intent, automation for its own sake, excessive abstraction that removes learner context, governance that creates unnecessary complexity, or systems that become difficult to maintain. Reinforce that reusable content works when structure protects context and quality.",
  "human-centered-change":
    "For Human-Centered Change, Ethics, and Learner Trust responses, evaluate whether the learner identified a real trust risk, whether transparency is specific and learner-facing, whether safeguards reduce meaningful harm or confusion, whether learner agency is preserved, whether visible limits are clear, whether bias, privacy, psychological safety, or misuse risks are considered where relevant, whether the design earns trust through choices rather than messaging, and whether the learner demonstrates responsible professional judgment. Do not reward vague ethics language, communication-only change plans, trust as messaging, AI adoption without safeguards, performative transparency, or learner agency that is implied but not designed. Reinforce that trust is designed.",
};
